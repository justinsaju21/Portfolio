...
const TargetCursor = ({
    targetSelector = 'a, button, input, textarea, [role="button"], .cursor-target, .glass-card, [class*="Card"], [class*="magnetic"], [class*="Button"], [class*="btn"], .rounded-full[class*="bg-"], [class*="pill"]',
    spinDuration = 2,
    ...
    // Fix hydration: always render null on server, check mobile on client
