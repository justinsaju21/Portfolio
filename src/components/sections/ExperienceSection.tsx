...
const experiences = [
    {
        ...
        location: "Taiwan",
        period: "2024 - Present",
        description: "Engaged in specialized research and learning on System-on-Chip (SoC) testing methodologies and VLSI design verification.",
        skills: ["SoC Testing", "VLSI Design", "DFT", "Fault Modeling", "Test Patterns"],
        highlights: [
            "Studying advanced SoC testing architectures and strategies",
            "Learning about Design for Testability (DFT) techniques",
            "Exploring fault modeling and automatic test pattern generation",
            "Understanding semiconductor testing standards and protocols",
        ],
        icon: Cpu,
    ...
    },
    {
        ...
        location: "Chennai",
        period: "2024",
        description: "Intensive capstone program on thermal management in electronic devices, taught by industry expert with experience at both Intel and Dell.",
        skills: ["ANSYS Icepak", "Thermal Management", "CFD Simulation", "Data Center Cooling", "Heat Dissipation"],
        highlights: [
            "Mastered ANSYS Icepak for thermal simulation and analysis",
            "Studied thermal management techniques for electronic devices",
            "Analyzed data center cooling strategies and optimization",
            "Applied computational fluid dynamics to heat transfer problems",
        ],
        icon: Thermometer,
...
const connectionPoints = [
    {
        title: "Data-Driven Thermal Analysis",
        description: "Power BI dashboards can visualize real-time thermal data from data centers, combining data science with thermal management.",
        icon: BarChart3,
    },
    {
        title: "Cloud Infrastructure Cooling",
        description: "Understanding Azure infrastructure helps optimize cooling strategies for cloud data centers where thermal efficiency is critical.",
        icon: Server,
    },
    {
        title: "Predictive Maintenance",
        description: "ML models can predict thermal failures in electronic systems, bridging data analytics with hardware reliability.",
        icon: Cpu,
    },
];
