...
const certifications = [
    ...
    {
        title: "Microsoft Azure Fundamentals: Cloud Concepts",
        issuer: "Microsoft Learn",
        icon: GraduationCap,
    ...
    {
        title: "Microsoft Azure Data Fundamentals: Core Data Concepts",
        issuer: "Microsoft Learn",
        icon: Database,
    ...
    },
    {
        ...
        description: "Mastering the art of beautiful handwriting and artistic lettering.",
    },
];
